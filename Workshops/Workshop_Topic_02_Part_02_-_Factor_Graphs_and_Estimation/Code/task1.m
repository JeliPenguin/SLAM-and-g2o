...
maxMeasurements = 100;
covariances = zeros(maxMeasurements,1);

for numberOfMeasurements = 1:maxMeasurements

    % Some parameters
    if mod(numberOfMeasurements,2) == 0
        sigmaR = 10;
    else
        sigmaR = 1;
    end
    ...
    X(idx);
    covariances(numberOfMeasurements) = (PX(idx, idx));
